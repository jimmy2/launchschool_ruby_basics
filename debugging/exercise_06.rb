# Ruby Basics > Debugging > Confucius Says
...
# last if (if person == 'Einstein') statement is returning nil
# change to if, elsif statement or case statement

# alternatively add explicit return statements
